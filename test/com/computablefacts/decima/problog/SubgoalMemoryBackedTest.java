...
public class SubgoalMemoryBackedTest {
  ...
  public void testLiteralsSwapping1() throws Exception {
    ...
    // Query kb
    // s1(1)?
    Solver solver = new Solver(kb, new Functions(kb), true, SubgoalMemoryBacked::new);
  ...
  public void testLiteralsSwapping2() throws Exception {
    ...
    Solver solver = new Solver(kb, new Functions(kb), true, fact -> new SubgoalMemoryBacked(fact, facts::add));

...
public class VocabularyTest {
  ...
  public void testCommandLineExtractUnigrams() throws Exception {
    ...
    File vocabularyDecompressed = new File(String.format("%s/vocabulary-1grams.tsv", documents.getParent()));
  ...
  public void testCommandLineExtractBigrams() throws Exception {
    ...
    File documents = DocumentTest.documents();
    File vocabularyCompressed = new File(String.format("%s/vocabulary-2grams.tsv.gz", documents.getParent()));
    File vocabularyDecompressed = new File(String.format("%s/vocabulary-2grams.tsv", documents.getParent()));
  ...
  public void testCommandLineExtractTrigrams() throws Exception {
    ...
    File documents = DocumentTest.documents();
    File vocabularyCompressed = new File(String.format("%s/vocabulary-3grams.tsv.gz", documents.getParent()));
    File vocabularyDecompressed = new File(String.format("%s/vocabulary-3grams.tsv", documents.getParent()));

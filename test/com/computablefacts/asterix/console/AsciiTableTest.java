...
public class AsciiTableTest {
  ...
  public void testTableWithNullValues() {
    ...
    String[][] testTable = new String[][]{{"id", "First Name", "Last Name", "Age"}, {"1", null, null, null}};
  ...
  public void testRightJustifiedTableWithHeader() {
    ...
    String[][] testTable = new String[][]{{"id", "First Name", "Last Name", "Age"}, {"1", "John", "Johnson", "45"},
  ...
  public void testDataWrapping() {
    ...
    String[][] testTable = new String[][]{{"id", "First Name", "Last Name", "Age", "Profile"},
        ...
        {"3", "Rose", "Johnson Johnson Johnson Johnson Johnson Johnson Johnson Johnson Johnson Johnson", "22",
            "My name is Rose Johnson. My id is 3. My age is 22."}, {"4", "Jimmy", "Kimmel", "",

...
public class ConsoleAppTest {
  ...
  public void testGetFileCommand() throws IOException {
    ...
    Assert.assertEquals(file.getAbsolutePath(), ConsoleApp.getFileCommand(args, "cmd", "").getAbsolutePath());
    Assert.assertEquals(file.getAbsolutePath(), ConsoleApp.getFileCommand(args, "cmd", null).getAbsolutePath());
  }

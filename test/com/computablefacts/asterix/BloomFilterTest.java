...
public class BloomFilterTest {
  ...
  public void testConstructorCNK() throws Exception {
    ...
    for (int i = 0; i < 10000; i++) {
      ...
      assertEquals(bf.k(), k);
      assertEquals(bf.expectedBitsPerElement(), c, 0);
      assertEquals(bf.expectedNumberOfElements(), n);

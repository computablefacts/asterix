...
public abstract class AbstractNode {
  ...
  final public long cardinality(DataStore dataStore, Authorizations authorizations, String dataset) {
    return cardinality(dataStore, authorizations, dataset, null);
  }

  final public View<String> execute(DataStore dataStore, Authorizations authorizations, String dataset) {
  ...
  public abstract long cardinality(DataStore dataStore, Authorizations authorizations, String dataset,
      Function<String, SpanSequence> tokenizer);

  public abstract View<String> execute(DataStore dataStore, Authorizations authorizations, String dataset,
